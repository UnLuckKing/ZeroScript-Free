...
- New Hub tabs for task queue, specialist tools, progress/history, and per-game profiles.
...
- Updates now preserve `hub_profiles.json` in addition to token, settings, and MCP config.
